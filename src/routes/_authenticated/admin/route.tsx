...
const NAV = [
  ...
  { to: "/admin/popular-products", label: "Home · Product Sections", icon: Rows3 },
  { to: "/admin/category-sections", label: "Home · Category Sections", icon: Grid2X2 },
  { to: "/admin/store-sections", label: "Home · Store Sections", icon: Store },
  { to: "/admin/store-product-sections", label: "Store · Product Sections", icon: Rows3 },
