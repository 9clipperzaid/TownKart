...
const Bike = createLucideIcon("bike", __iconNode$P);
...
const PackageCheck = createLucideIcon("package-check", __iconNode$q);
const __iconNode$p = [
  [
    "path",
    {
...
const ShieldBan = createLucideIcon("shield-ban", __iconNode$f);
const __iconNode$e = [
  [
    "path",
    {
